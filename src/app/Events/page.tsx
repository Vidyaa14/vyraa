  ...
  return (
    <>
      <div className="relative w-full min-h-screen">
        ...
        {/* Hero Section */}
        <div className="absolute inset-0 flex flex-col items-center justify-start mt-4 text-black top-[20vh] z-10">
        ...
        {/* Events Section */}
        <div className=" px-6 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 absolute inset-0  items-center  text-black mt-16">
          {events.map((event) => (
            <div
              key={event.event_id}
              className="border hover:scale-105 transform transition duration-300 bg-white rounded-lg shadow-md overflow-hidden"
            >
              {/* Event Image */}
              ...
              <div className="p-4 text-black">
                <h3 className="text-lg font-bold text-black">{event.event_name}</h3>
                <p className="text-gray-600 text-sm text-black mt-1">{event.event_description}</p>
                ...
                <p className="text-sm inline-block mt-2 bg-red-200 text-black rounded-full px-2 py-1 text-xs">
